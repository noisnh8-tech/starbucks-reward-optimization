...
Opt-in 전환 전략으로 리워드 비용 절감 구조(Simulation 기준 +$24,324)를 도출한 마케팅 분석 프로젝트

---

## 1. 문제 정의

오퍼를 확인하지 않은 고객에게도 리워드가 자동 지급되는 구조가 반복  
→ 전체 리워드 비용의 **16.5%** 가 마케팅 기여 없이 소진 ㅡ오퍼 없이도 구매할 고객에게 불필요한 비용이 추가되는 구조
...
| Opt-in 전환 시 낭비 차단 | ✅ | 루틴형 고객 오퍼 축소 시 **+$24,324** 절감(Simulation) |
...
| 05 | `05_strategy.ipynb` | 전략 도출 — **+$24,324** 절감 구조 설계(Simulation) |
...
| Opt-in 전환 절감 | **+$24,324** | 루틴형 고객(상위 30%, 4,350명) 오퍼 축소 시 Simulation 기대 순효과 |
